...
var myFriend = {firstName:"mutasim",lastName:"hassan",age: 34, eyeColor:"honey",   //intiating the object person
fullName:function fullName(){return this.firstName +   this.lastName},
friendAge:function friendAge(){return this.age},friendEyeColor:function friendEyeColor(){ return this.eyeColor}}
...
function reply() { //declaring reply function
 ...
 else if (question === myFriend.firstName){
  document.getElementById('output').value +="Hey you know that friend? I know that friend too! Their full name is: " + myFriend.fullName();
  // mutasim.myFriend();
 }
...
//creating friend function and declaring it's arguements
//function friend(firstName, lastName, age, eyeColor) {
 ...
 //console.log("Hey you know that friend? I know that friend too! Their full name is: " + this.firstName + this.lastName + "!");
 //};
 //this.friendInfo = function() {
  // console.log(this.age);
 //}
//}
//const mutasim = new friend("mutasim", "hassan", 34, "honey");
// shah.greeting();
//friend();
//mutasim.myFriend();
