...
else if (question == "Show me the weather for today"){// getting the input value for the vae question
  debugger;
 showWeather();
 }
else{
...
function loadDoc() {
 ...
 async function showWeather() {
  let response = await fetch(
    'http://api.openweathermap.org/data/2.5/forecast?q=toronto&id=524901&APPID=5fd6885f22db74a75577fb62515ae40c'
  );
